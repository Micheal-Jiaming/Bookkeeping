...
contain no logic.
    ...
    py bookkeeping.py            # run from source, same as the .exe
    py bookkeeping.py --help     # options (data folder, version)
"""
...
if __name__ == "__main__":
    # Harmless here (the app is single-process) but mandatory insurance in a
    # frozen build: without it, any library that spawns a process would
